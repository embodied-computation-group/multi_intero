...
cat("Step 4: Computing Bayes factors (BF01)...\n")
...
# Create heatmap
heatmap_plot <- ggplot(bf01_long, aes(x = Column, y = Row, fill = Value)) + #x =Column
...
# Save the heatmap
tryCatch({
  ggsave(filename = "figs/interoextero_corr_bayes_all.png", height = 7, width = 7, bg = 'white')
